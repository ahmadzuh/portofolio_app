					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav justify-content-end">
							...
							<li class="nav-item submenu dropdown">
								<a href="page/p" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
							...
							<li class="nav-item submenu dropdown">
								<a href="p" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
				...
				<div class="row">
					<div class="col-lg-7">
						<div class="banner_content">
							...
							<h1 class="text-uppercase">I am Ahmad zuhdi</h1>
							<h5 class="text-uppercase">Flutter developer</h5>
							<div class="d-flex align-items-center">
								<a class="primary_btn" href="p"><span>Hire Me</span></a>
								<a class="primary_btn tr-bg" href="p"><span>Get CV</span></a>
							</div>
						</div>
					</div>
					<div class="col-lg-5">
			...
			<div class="row justify-content-start align-items-center">
				...
				<div class="offset-lg-1 col-lg-5">
					<div class="main_title text-left">
						...
						<a class="primary_btn" href="p"><span>Download CV</span></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-12">
					<div class="footer_top flex-column">
						...
						<div class="footer_social">
							<a href="https://www.facebook.com/ahmadzuhdi65"><i class="fa fa-facebook"></i></a>
							<a href="https://github.com/ahmadzuh?tab=repositories"><i class="fa fa-github"></i></a>
							<a href="p"><i class="fa fa-dribbble"></i></a>
							<a href="p"><i class="fa fa-behance"></i></a>
						</div>
					</div>
				</div>
			</div>
